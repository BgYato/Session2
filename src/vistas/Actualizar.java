...
public class Actualizar extends javax.swing.JFrame {
    ...
    ArrayList<EmpleadoVO> mostrarEmpleadoUnico;
    ...
    public void traerDatos(){
        mostrarEmpleadoUnico = empleDao.mostrarEmpleadoUnico(rId);
        
        if (!mostrarEmpleadoUnico.isEmpty()) {
            EmpleadoVO empleado = mostrarEmpleadoUnico.get(0);
            
            String perfil = empleado.getEmpAdmin();
            
            jTextFieldNombre.setText(empleado.getEmpNombre());
            jTextFieldApellido.setText(empleado.getEmpApellido());
            jTextFieldTelefono.setText(empleado.getEmpPhone());
            jTextFieldUsuario.setText(empleado.getEmpUsu());
            ...
            jTextFieldPassword.setText(empleado.getEmpPwd());
        } else {
            System.out.println("los datos están vacios");
        }
    }
    ...
    public void actualizarUsuario(){
        ...
        if (empDAO.actualizarRegistro()) {
            JOptionPane.showMessageDialog(null, empUsu + " ha sido actualizado correctamente.");  
